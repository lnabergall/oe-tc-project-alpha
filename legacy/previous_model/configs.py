...
PARAMS = {
    ...
    "gamma": [0.0, 0.001, 0.01, 0.03, 0.05, 0.1, 0.2, 0.5, 1.0],

    "D": [0.5, 1.0, 2.0],

    "g": [0.00001, 0.00003, 0.0001, 0.0003, 0.001, 0.003, 0.01],
    "alpha": [5.0, 10.0, 15.0, 20.0, 40.0, 80.0, 160.0],
    "kappa": [5, 10, 20, 40, 80, 160],

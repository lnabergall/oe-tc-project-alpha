...
def test_potential_factors(r, LQ, pad_value):
    """
    ...
    """
    n = LQ.shape[0]
    nbhd_idxs = generate_neighborhood(r, n, pad_value)
...
@partial(jax.jit, static_argnums=[2])
def test_potential(r, LQ, pad_value):
    """
    ...
    V = jnp.where(LQ[r[0], r[1]] == pad_value, jnp.sum(V_nbhd), jnp.inf)
    return V
...
def compute_bond_data(i, K, R, L, Q, pad_value):
    ...
    r_nbhd = generate_open_neighorhood(r, n, pad_value)
